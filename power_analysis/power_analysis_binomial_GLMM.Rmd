...
load("power_sim_disjsyll_order_as_factor_1000iter_12tr.RData")
```
...
#save.image("power_sim_disjsyll_order_as_factor_1000iter_12tr.RData")
```
...
p <- ggplot(data = lrt.data2, aes(y=proportion.sign.lrt2))+
