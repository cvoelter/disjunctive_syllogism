...
load("power_sim_disjsyll_order_as_factor_1000iter_12tr_2levels.RData")
```
...
#save.image("power_sim_disjsyll_order_as_factor_1000iter_12tr_2levels.RData")
```
...
ggsave(p.con2, filename = "condition_model.png", scale = 0.5, height = 9, width = 16)
```
