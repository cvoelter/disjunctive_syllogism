...
test.per <- 0.65 # performance in test condition
...
coefs <- c(
  "(Intercept)" = log(test.per / (1 - test.per)),
  "z.trial" = 0
)
...
p <- ggplot(data = icpt.p.data, aes(y=proportion.sign.icpt.p))+
 ...
 p
ggsave("intercept_only_simu.png")
