---
title: "Intercept-only models - power analysis"
...
load("power_sim_disjsyll_1000iter_intercept_only.RData")
```
...
#save.image("power_sim_disjsyll_1000iter_intercept_only.RData")
```
