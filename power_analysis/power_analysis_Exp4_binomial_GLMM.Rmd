---
title: "power analysis - Exp4 binomial GLMM"
...
load("power_sim_disjsyll_Exp4_GLMM.RData")
```
...
#save.image("power_sim_disjsyll_Exp4_GLMM.RData")
```
...
p.exp4.con2 <- ggdraw(plot_grid(p.con,p.exp4.con, p.leg, ncol = 1, nrow = 3, rel_heights = c(1,1, 0.15)))
