...
exp3_4_plot<-plot_grid(exp3_plot, exp4_plot, exp34_plot, labels = c("A", "B", "C"), nrow=1)

ggsave(exp3_4_plot, filename = "figures/Experiment3and4_Figure5.png", width = 15, height = 5, scale = 0.65)
```
